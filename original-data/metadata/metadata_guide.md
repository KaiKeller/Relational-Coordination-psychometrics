...
The survey was embedded in the innofonds project eliPfad (www.elipfad.de) - Förderkennzeichen: 01NVF21114

This work package was carried out through the collaboration of the following institutes:
...
- Correspondence (e-mail): kai.keller@ukbonn.de 
...
**Collection Modes (Experimental Conditions):**  
  1. Postal invitation with enclosed paper questionnaire  
  2. Postal invitation with online participation option (QR code / link)  
  3. Email invitation with online participation option (QR code / link)

**Follow-up Procedures:**  
- Two reminders sent to all groups

**Survey Platform:**  
- LimeSurvey (for online participation)

**Incentives:**  
- Unconditional incentive (chocolate bar in postal survey groups)
...
-> see `eliPfad_data_tidy.R` script in `command-files`folder.
...
**Ethics Approval:**  
- Ethics Committee of the Medical Faculty Cologne (#23-1232)

**Registration:**  
- German Clinical Trials Register (DRKS00031500)

**Informed Consent:**  
- Implied via survey participation (anonymous)
